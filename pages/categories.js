                ...
                <div className="w-full h-auto">
                    <div className="w-full h-auto sm:h-16 flex flex-col sm:flex-row justify-around items-center my-2">
                        <button className="w-auto h-9 md:h-10 mt-3 px-3 py-2 bg-transparent flex flex-row justify-around items-center text-gray-800 dark:text-gray-300 border border-primary rounded outline-none">
                            <span className="px-1 text-sm md:text-base">ثبت دسته&zwnj;بندی جدید</span>
                            ...
                            <Table>
                                <TableHead>
                                    <TableRow className={'text-center h-12 text-sm border-b-2 border-slate-300 dark:border-slate-200'}>
                                        ...
                                        <TableCell component="th">
                                            <span className="text-primary inline-block mx-auto px-0.5">زیر مجموعه</span>
                                        </TableCell>
                                        <TableCell component="th">
                                            <span className="text-primary inline-block mx-auto px-0.5">تصویر بندانگشتی</span>
                                        </TableCell>
                                        <TableCell component="th">
                                            <span className="text-primary inline-block mx-auto px-0.5">تصویر نمایشی (برای نمایش دسته)</span>
                                        </TableCell>
                                        <TableCell component="th">
                                ...
                                <TableBody>
                                    <TableRow className={'text-center text-sm lg:text-base border-b mx-auto border-slate-300'}>
                                        ...
                                        <TableCell>-</TableCell>
                                        <TableCell className={'w-8 h-8'}>-</TableCell>
                                        <TableCell>-</TableCell>
                                        <TableCell>1401/10/21</TableCell>
                                    </TableRow>
                                    <TableRow className={'text-center text-sm lg:text-base border-b mx-auto border-slate-300'}>
                                        <TableCell>1</TableCell>
                                        <TableCell>لوازم خواب</TableCell>
                                        <TableCell>لوازم خانگی</TableCell>
                                        <TableCell className={'w-8 h-8'}>
                                            <img src="../assets/images/cat-2.jpg" width={64} height={64} className="mx-auto rounded-sm" />
                                        </TableCell>
                                        <TableCell className={'w-8 h-8'}>
                                            <img src="../assets/images/cat-2.jpg" width={64} height={64} className="mx-auto rounded-sm" />
                                        </TableCell>
                                    ...
                                    <TableRow className={'text-center text-sm lg:text-base border-b mx-auto border-slate-300'}>
                                        ...
                                        <TableCell>لوازم خانگی</TableCell>
                                        <TableCell className={'w-8 h-8'}>
                                            <img src="../assets/images/cat-1.jpg" width={64} height={64} className="mx-auto rounded-sm" />
                                        </TableCell>
                                        <TableCell className={'w-8 h-8'}>
                                            <img src="../assets/images/cat-1.jpg" width={64} height={64} className="mx-auto rounded-sm" />
                                        </TableCell>
                                    ...
                                    <TableRow className={'text-center text-sm lg:text-base'}>
                                        <TableCell>1</TableCell>
                                        <TableCell>لوازم برقی</TableCell>
                                        <TableCell>لوازم خانگی</TableCell>
                                        <TableCell className={'w-8 h-8'}>
                                            <img src="../assets/images/cat-3.jpg" width={64} height={64} className="mx-auto rounded-sm" />
                                        </TableCell>
                                        <TableCell className={'w-8 h-8'}>
                                            <img src="../assets/images/cat-3.jpg" width={64} height={64} className="mx-auto rounded-sm" />
                                        </TableCell>
