...
function ChangePassword({ token, res }) {
    ...
    const [characterLength, setCharacterLength] = useState(13);
                ...
                <div style={{ width: '98%', height: 'auto' }} className="border mx-auto mt-px dark:border-gray-600 rounded shadow-sm dark:shadow-slate-600">
                    <div className="w-full h-auto flex flex-col mt-2 mb-8">
                        <div className="w-full h-auto grid place-content-center items-center place-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-[30%_minmax(40%,_1fr)_30%]">
                            <section className="w-11/12 sm:w-10/12 h-auto mx-auto flex flex-col justify-around lg:mr-8">
                                {user.has_password && (
                                    <>
                                        <TextField
                                            label={'رمز عبور قبلی'}
                                        ...
                                        >
                                            ...
                                            <Link href={'#'}>
                                                <div className="absolute top-full right-1">
                                                    <span className="text-sm text-primary cursor-pointer">فراموشی رمز عبور</span>
                                                </div>
                                            </Link>
                                        </TextField>
                                        <div className="my-8" />
